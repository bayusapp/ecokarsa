...
function hapus_banner(id) {
  $.ajax({
    url: baseUrl+'/admin/banner/ajaxbanner',
    method: 'post',
    data: {
      id: id
    },
    success: function(response) {
      swal({
        ...
        window.location.href = baseUrl+'/admin/banner/hapusbanner/'+id;
      });
    }
  });
}
  ...
  $.ajax({
    ...
    success: function(response) {
      swal({
        ...
        window.location.href = baseUrl+'/admin/FAQ/hapusfaq/'+id;
      });
    }
  });
}
  ...
  $.ajax({
    ...
    success: function(response) {
      swal({
        ...
        window.location.href = baseUrl+'/admin/tim/hapustim/'+id;
      });
    }
  });
}