...
<head>
  <meta charset="utf-8">
  <meta name="description" content="Ecokarsa Company Profile">
  <meta name="keywords" content="Ecokarsa">
  <meta name="author" content="Bayu Setya Ajie Perdana Putra">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Ecokarsa | Log in</title>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?= $url_bootstrap ?>plugins/iCheck/square/blue.css">
...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="<?= base_url() ?>">Ecokarsa<br>(bisa pakai logo)</a>
    </div>
    <!-- /.login-logo -->
    <?php
    if (flashdata('msg')) {
  ...
  <!-- iCheck -->
  <script src="<?= $url_bootstrap ?>plugins/iCheck/icheck.min.js"></script>
  <script>
    $(function() {
      $('input').iCheck({
