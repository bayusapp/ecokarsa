  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; Copyright <strong><span><?= $perusahaan->nama_perusahaan ?></span></strong>. Developed by <a href="https://bayusapp.com" target="_blank"><strong><span>Bayu SAPP</span></strong></a>. All Rights Reserved
        </div>
        <div class="credits">
